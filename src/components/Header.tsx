            ...
            <li className="relative">
              ...
              >
                ...
                >
                  <li>
                    <button
                        className={`${classesUserMenu} ${authLevel === 2 && 'bg-gray-100 text-blue-700'}`}
                        onClick={handleClickPlan.bind(null, 2)}    
                    >
                      Basic Plan
                    </button>
                  </li>
                  <li>
                    <button 
                        className={`${classesUserMenu} ${authLevel === 3 && 'bg-gray-100 text-blue-700'}`}
                        onClick={handleClickPlan.bind(null, 3)}
                        >
                      Admin Plan
                    </button>
                  </li>
                ...
                <div className="py-1">
                  <button 
                    ...
                    onClick={handleClickPlan.bind(null, 1)}
                    >
                    Sign out
                  </button>
                </div>
